          ...
          <div className="dropdown dropdown-bottom dropdown-end rounded-lg">
            ...
            <div tabIndex={0} className="dropdown-content z-50 card card-compact w-auto p-2 shadow bg-neutral text-primary-content">
              <div className="card-body">
                ...
                <div className="join">
                  <select className="faction select select-secondary rounded-l-full" name="factionFilter" onChange={this.handleChange}>
                  ...
                  <select className="classes select select-secondary rounded-r-full" name="classFilter" onChange={this.handleChange}>
                ...
                <div className="flex justify-between">
                  ...
                  <button className="btn btn-primary rounded-full" onClick={this.mountListMaker}>
